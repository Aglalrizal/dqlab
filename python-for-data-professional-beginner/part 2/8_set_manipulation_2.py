...
print(parcel1)
# Output: {'Anggur','Apel','Jeruk'}
print(parcel3)
# Output: {'Anggur','Apel','Jeruk','Kiwi','Melon'}}
...
# Fitur .intersection(): Mengembalikan elemen elemen yang terkandung dalam set-set (irisan)
...
print(parcel_C)
# Output: {'Anggur', 'Melon', 'Semangka', 'Leci'}